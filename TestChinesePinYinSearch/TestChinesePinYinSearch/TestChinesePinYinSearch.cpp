...
// TestChinesePinYinSearch.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CTestChinesePinYinSearchApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CTestChinesePinYinSearchApp 构造

CTestChinesePinYinSearchApp::CTestChinesePinYinSearchApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的一个 CTestChinesePinYinSearchApp 对象

CTestChinesePinYinSearchApp theApp;


// CTestChinesePinYinSearchApp 初始化

BOOL CTestChinesePinYinSearchApp::InitInstance()
{
	...
	CTestChinesePinYinSearchDlg dlg;
	m_pMainWnd = &dlg;
