...
void CScrollHelper::ScrollVScrollToPos(UINT nPos)
{
   if ( m_attachWnd == NULL )
      return;

   int deltaPos = nPos - m_scrollPos.cy;
   ...
   /*m_attachWnd->SetScrollPos(SB_VERT, nPos, TRUE);
   m_attachWnd->ScrollWindow(0, m_scrollPos.cy - nPos);*/
